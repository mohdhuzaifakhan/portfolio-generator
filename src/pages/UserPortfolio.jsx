    ...
    useEffect(() => {
        auth.onAuthStateChanged(function (user) {
            if (user) {
                ...
                setUser(user)
                // Perform actions for signed-in user, such as showing user-specific content
            } else {
                // User is signed out
                console.log("User is signed out");
                // Perform actions for signed-out user, such as redirecting to the login page
            }
        });
    ...
    return (
        <div>
            ...
            <div class="container-fluid bg-light">
                <div id="Intro" class="container-fluid shadow-sm bg-white border-rounded m-auto d-flex justify-content-center p-4">
                    <div className="row my-4 justify-content-center">
                        <div class="col-lg-3 col-md-6  d-flex align-items-center justify-content-center justify-content-lg-end">
                            <div className=''>
